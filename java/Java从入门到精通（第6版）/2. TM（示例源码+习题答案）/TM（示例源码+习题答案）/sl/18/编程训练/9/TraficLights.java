	...
	public TraficLights() { // TraficLights的构造方法
		...
		rbtnRed.addActionListener(new ActionListener() { // 添加动作监听的事件
			...
			public void actionPerformed(ActionEvent e) { // 发生操作时
				lblImage.setIcon(new ImageIcon(TraficLights.class.getResource("red.png"))); // 标签中添加图片
			}
		});
		...
		rbtnYellow.addActionListener(new ActionListener() { // 添加动作监听的事件
			@Override
			public void actionPerformed(ActionEvent e) { // 发生操作时
				lblImage.setIcon(new ImageIcon(TraficLights.class.getResource("yellow.png"))); // 标签中添加图片
			}
		});
		...
		rbtnGreen.addActionListener(new ActionListener() { // 添加动作监听的事件
			@Override
			public void actionPerformed(ActionEvent e) { // 发生操作时
				lblImage.setIcon(new ImageIcon(TraficLights.class.getResource("green.png"))); // 标签中添加图片
			}
		});
