...
public class Pictures extends JFrame { // 创建一个“图片”类，并继承JFrame
	...
	public Pictures() { // Pictures的构造方法
		...
		switch (num) { // 多分支语句
		case 0: // 生成的随机数为“0”时
			lblBackground.setIcon(new ImageIcon(Pictures.class.getResource("1.png"))); // 图标中添加图片“Birds.jpg”
			break;
		case 1: // 生成的随机数为“1”时
			lblBackground.setIcon(new ImageIcon(Pictures.class.getResource("2.png"))); // 图标中添加图片“Snow.jpg”
			break;
		case 2: // 生成的随机数为“2”时
			lblBackground.setIcon(new ImageIcon(Pictures.class.getResource("3.png"))); // 图标中添加图片“Trees.jpg”
			break;
		}
